...
public class FaithTrack implements VictoryPointCalculator {
    ...
    //TODO: considerare anche i punti del tracciato
    @Override
    ...
    //method that returns true if i have reached a checkpoint and if i'm actually the first that has reached that checkpoint
    ...
    //@param the number of the checkpoint which i'm analyzing
    ...
    * @param the number of the checkpoint to control
    */
