...
public class Board  implements VictoryPointCalculator{
    ...
    public void addProductionLeader(int victoryPoints, RequirementLevelDevelop requirement, Production production){
        ProductionLeaderCard newProd= new ProductionLeaderCard(victoryPoints, requirement, production);
 ...
 */
    public void removeResources(TreeMap<Resource, Integer> resToGive){
        //controllare prima in depot normali, poi depot leader e poi strongbox
        // se maggiore di stored allora clear e salva quanto hai tolto, altrimenti spendResource
        int tmp;
