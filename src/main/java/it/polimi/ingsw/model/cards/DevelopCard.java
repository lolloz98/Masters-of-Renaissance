...
public class DevelopCard implements Card, VictoryPointCalculator{
     ...
     */
    public TreeMap<Resource, Integer> activateProduction(TreeMap<Resource, Integer> resourcesToGive, Board board){
        // TODO: check this implementation after board implementation
        return production.applyProduction(resourcesToGive, board);
    }
}
